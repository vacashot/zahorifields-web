...
const videos = [
  { src: '/galeria/modulo_cobertura_vegetal.mp4',  caption: 'Módulo cobertura vegetal' },
  { src: '/galeria/modulo_mascara_vegetacion.mp4', caption: 'Módulo máscara de vegetación' },
