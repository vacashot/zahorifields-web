...
const channels = [
  { icon: GitBranch, title: 'GitHub Issues', desc: 'Reporta errores, sugiere funcionalidades o consulta el estado del desarrollo.', label: 'Abrir un issue', url: 'https://github.com/vacashot/zahori_issues_publicas/issues' },
