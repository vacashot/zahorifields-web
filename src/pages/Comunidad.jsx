...
const channels = [
  ...
  { icon: MessageCircle, title: 'Discord', desc: 'Canal de la comunidad para preguntas, tutoriales y compartir resultados.', label: 'Unirse al servidor', url: 'https://discord.gg/SKHvkBV9Q' },
