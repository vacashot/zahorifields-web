...
const channels = [
  ...
  { icon: YouTubeLogo, title: 'YouTube', desc: 'Tutoriales en vídeo, demostraciones y novedades del proyecto ZahoriFields.', label: 'Ver el canal', url: 'https://www.youtube.com/@zahorifields' },
]
