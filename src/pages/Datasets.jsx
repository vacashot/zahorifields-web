...
const datasets = [
  ...
  {
    name: 'EX1_5band_RGBReNir.tif',
    sensor: 'RGB + RE + NIR',
    bands: { red: 1, green: 2, blue: 3, redEdge: 4, nir: 5, thermal: null },
    range: '0 – 32768',
    size: '128.8 MB',
    notesJsx: <span>Ensayos <a href="https://www.opendronemap.org/fieldimager" target="_blank" rel="noreferrer" className="text-accent hover:underline">FIELDimageR</a></span>,
  ...
  },
  {
    ...
    range: 'm (metros)',
    size: '3.5 MB',
    notesJsx: <span>MDS · <a href="https://www.opendronemap.org/fieldimager" target="_blank" rel="noreferrer" className="text-accent hover:underline">FIELDimageR</a></span>,
    url: 'https://github.com/vacashot/zahorifields-web/releases/download/v1.1-datasets/EX_DSM1.tif',
  },
  {
